...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, getResponseStatus, createError, getCookie, setCookie, sanitizeStatusCode, removeResponseHeader, getQuery as getQuery$1, readBody, getRouterParam, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getResponseStatusText } from 'file://C:/Users/Administrator/Desktop/booktech/booktech/node_modules/h3/dist/index.mjs';
import { escapeHtml } from 'file://C:/Users/Administrator/Desktop/booktech/booktech/node_modules/@vue/shared/dist/shared.cjs.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file://C:/Users/Administrator/Desktop/booktech/booktech/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, joinRelativeURL, parsePath, withLeadingSlash, withoutTrailingSlash, withTrailingSlash, decodePath } from 'file://C:/Users/Administrator/Desktop/booktech/booktech/node_modules/ufo/dist/index.mjs';
import destr, { destr as destr$1 } from 'file://C:/Users/Administrator/Desktop/booktech/booktech/node_modules/destr/dist/index.mjs';
import { renderToString } from 'file://C:/Users/Administrator/Desktop/booktech/booktech/node_modules/vue/server-renderer/index.mjs';
import { klona } from 'file://C:/Users/Administrator/Desktop/booktech/booktech/node_modules/klona/dist/index.mjs';
import defu, { defuFn, createDefu } from 'file://C:/Users/Administrator/Desktop/booktech/booktech/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file://C:/Users/Administrator/Desktop/booktech/booktech/node_modules/scule/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file://C:/Users/Administrator/Desktop/booktech/booktech/node_modules/unhead/dist/server.mjs';
import { stringify, uneval } from 'file://C:/Users/Administrator/Desktop/booktech/booktech/node_modules/devalue/index.js';
import { isVNode, isRef, toValue } from 'file://C:/Users/Administrator/Desktop/booktech/booktech/node_modules/vue/index.mjs';
import { createHooks } from 'file://C:/Users/Administrator/Desktop/booktech/booktech/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file://C:/Users/Administrator/Desktop/booktech/booktech/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file://C:/Users/Administrator/Desktop/booktech/booktech/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/Users/Administrator/Desktop/booktech/booktech/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/Users/Administrator/Desktop/booktech/booktech/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file://C:/Users/Administrator/Desktop/booktech/booktech/node_modules/ohash/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/Users/Administrator/Desktop/booktech/booktech/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file://C:/Users/Administrator/Desktop/booktech/booktech/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file://C:/Users/Administrator/Desktop/booktech/booktech/node_modules/youch-core/build/index.js';
import { Youch } from 'file://C:/Users/Administrator/Desktop/booktech/booktech/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file://C:/Users/Administrator/Desktop/booktech/booktech/node_modules/source-map/source-map.js';
import { createRouterMatcher } from 'file://C:/Users/Administrator/Desktop/booktech/booktech/node_modules/@nuxtjs/i18n/node_modules/vue-router/vue-router.node.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { getContext } from 'file://C:/Users/Administrator/Desktop/booktech/booktech/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://C:/Users/Administrator/Desktop/booktech/booktech/node_modules/errx/dist/index.js';
import _wH6JrtIxmaSoA8lCPWFnE9z4lQeXW6H5z3l5aymEQw from 'file://C:/Users/Administrator/Desktop/booktech/booktech/node_modules/@nuxt/vite-builder/dist/fix-stacktrace.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1, isAbsolute } from 'file://C:/Users/Administrator/Desktop/booktech/booktech/node_modules/pathe/dist/index.mjs';
import { walkResolver } from 'file://C:/Users/Administrator/Desktop/booktech/booktech/node_modules/unhead/dist/utils.mjs';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file://C:/Users/Administrator/Desktop/booktech/booktech/node_modules/ipx/dist/index.mjs';

const serverAssets = [{"baseName":"server","dir":"C:/Users/Administrator/Desktop/booktech/booktech/server/assets"}];
...
storage$1.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:/Users/Administrator/Desktop/booktech/booktech","watchOptions":{"ignored":[null]}}));
storage$1.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:/Users/Administrator/Desktop/booktech/booktech/server","watchOptions":{"ignored":[null]}}));
storage$1.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:/Users/Administrator/Desktop/booktech/booktech/.nuxt"}));
storage$1.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:/Users/Administrator/Desktop/booktech/booktech/.nuxt/cache"}));
storage$1.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:/Users/Administrator/Desktop/booktech/booktech/.data/kv"}));
...
const _9nbnLR_2Us5r3scNs_hK9JBbGbOCuO8n_MmMlosLuTU = (function(nitro) {
...
const rootDir = "C:/Users/Administrator/Desktop/booktech/booktech";
...
const _p5jJLnjp0kZBl6m1zMxEELCdJhiMjw8ysK8qHYjWmT0 = (nitroApp) => {
...
const plugins = [
  _9nbnLR_2Us5r3scNs_hK9JBbGbOCuO8n_MmMlosLuTU,
_YKhiYS36uhoMh9wOxxIxhlS0NMqC3E6Tt4rHXgIiWE,
_p5jJLnjp0kZBl6m1zMxEELCdJhiMjw8ysK8qHYjWmT0,
...
const getServerEntry = () => import('file://C:/Users/Administrator/Desktop/booktech/booktech/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
// @ts-expect-error file will be produced after app build
const getClientManifest = () => import('file://C:/Users/Administrator/Desktop/booktech/booktech/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
// -- SSR Renderer --
...
const _ZSeVMm = _messagesHandler ;
...
const _lazy_kTU5EE = () => Promise.resolve().then(function () { return _slug__get$1; });
const _lazy_QTlD9N = () => Promise.resolve().then(function () { return index_get$3; });
const _lazy_U7RT7E = () => Promise.resolve().then(function () { return checkout_post$1; });
const _lazy_jSx9zx = () => Promise.resolve().then(function () { return index_get$1; });
const _lazy_vcNKZt = () => Promise.resolve().then(function () { return newsletter_post$1; });
const _lazy_l7uGty = () => Promise.resolve().then(function () { return renderer; });
...
const MOCK_BOOKS$1 = {
  "clean-code": {
    ...
    category: "technology",
    coverUrl: "https://covers.openlibrary.org/b/id/8314081-L.jpg",
  ...
  "atomic-habits": {
    ...
    category: "self-help",
    coverUrl: "https://covers.openlibrary.org/b/id/8749476-L.jpg",
...
const MOCK_BOOKS = [
  ...
  },
  {
    ...
    category: "technology",
    coverUrl: "https://covers.openlibrary.org/b/id/8395463-L.jpg",
  ...
  },
  {
    ...
    category: "technology",
    coverUrl: "https://covers.openlibrary.org/b/id/8226162-L.jpg",
  ...
  },
  {
    ...
    category: "design",
    coverUrl: "https://covers.openlibrary.org/b/id/7930292-L.jpg",
  ...
  },
  {
    ...
    category: "science",
    coverUrl: "https://covers.openlibrary.org/b/id/8171310-L.jpg",
  ...
  },
  {
    ...
    category: "business",
    coverUrl: "https://covers.openlibrary.org/b/id/8219895-L.jpg",
...
const index_get$2 = defineEventHandler(async (event) => {
  ...
  const sortBy = (_a = query.sortBy) != null ? _a : "relevance";
  const page = Number((_b = query.page) != null ? _b : 1);
  const perPage = Number((_c = query.perPage) != null ? _c : 12);
  ...
  if (minPrice !== null) filtered = filtered.filter((b) => {
    var _a2;
    return ((_a2 = b.salePrice) != null ? _a2 : b.price) >= minPrice;
  });
  if (maxPrice !== null) filtered = filtered.filter((b) => {
    var _a2;
    return ((_a2 = b.salePrice) != null ? _a2 : b.price) <= maxPrice;
  });
  const sorted = filtered.sort((a, b) => {
    var _a2, _b2, _c2, _d;
    if (sortBy === "rating") return b.rating - a.rating;
    if (sortBy === "newest") return new Date(b.publishedAt).getTime() - new Date(a.publishedAt).getTime();
    if (sortBy === "price-asc") return ((_a2 = a.salePrice) != null ? _a2 : a.price) - ((_b2 = b.salePrice) != null ? _b2 : b.price);
    if (sortBy === "price-desc") return ((_c2 = b.salePrice) != null ? _c2 : b.price) - ((_d = a.salePrice) != null ? _d : a.price);
    return 0;
  });
